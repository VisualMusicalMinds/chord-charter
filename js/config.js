...
const majorKeyChordMap = {
  ...
  'Eb': [ { value: 'Eb', display: 'Eb / I' }, { value: 'Fm', display: 'Fm / ii' }, { value: 'Gm', display: 'Gm / iii' }, { value: 'Ab', display: 'Ab / IV' }, { value: 'Bb', display: 'Bb / V' }, { value: 'Cm', display: 'Cm / vi' }, { value: 'Ddim', display: 'Ddim / vii°' }, { value: 'F', display: 'F / V/V' }, { value: 'G', display: 'G / V/vi' }, { value: 'Db', display: 'Db / IV/IV' }],
  'E': [ { value: 'E',  display: 'E / I' }, { value: 'F#m',display: 'F#m / ii' }, { value: 'G#m',display: 'G#m / iii' }, { value: 'A',  display: 'A / IV' }, { value: 'B',  display: 'B / V' }, { value: 'C#m', display: 'C#m / vi' }, { value: 'D#dim', display: 'D#dim / vii°' }, { value: 'F#', display: 'F# / V/V' }, { value: 'G#', display: 'G# / V/vi' }, { value: 'D', display: 'D / IV/IV' }],
  'F': [ { value: 'F',  display: 'F / I' }, { value: 'Gm', display: 'Gm / ii' }, { value: 'Am', display: 'Am / iii' }, { value: 'Bb', display: 'Bb / IV' }, { value: 'C',  display: 'C / V' }, { value: 'Dm', display: 'Dm / vi' }, { value: 'Edim', display: 'Edim / vii°' }, { value: 'G', display: 'G / V/V' }, { value: 'A', display: 'A / V/vi' }, { value: 'Eb', display: 'Eb / IV/IV' }],
  'Gb': [ { value: 'Gb', display: 'Gb / I' }, { value: 'Abm',display: 'Abm / ii' }, { value: 'Bbm',display: 'Bbm / iii' }, { value: 'Cb', display: 'Cb / IV' },  { value: 'Db', display: 'Db / V' }, { value: 'Ebm', display: 'Ebm / vi' }, { value: 'Fdim', display: 'Fdim / vii°' }, { value: 'Ab', display: 'Ab / V/V' }, { value: 'Bb', display: 'Bb / V/vi' }, { value: 'Fb', display: 'Fb / IV/IV' }],
  'G': [ { value: 'G',  display: 'G / I' }, { value: 'Am', display: 'Am / ii' }, { value: 'Bm', display: 'Bm / iii' }, { value: 'C',  display: 'C / IV' }, { value: 'D',  display: 'D / V' }, { value: 'Em', display: 'Em / vi' }, { value: 'F#dim', display: 'F#dim / vii°' }, { value: 'A', display: 'A / V/V' }, { value: 'B', display: 'B / V/vi' }, { value: 'F', display: 'F / IV/IV' }],
  'Ab': [ { value: 'Ab', display: 'Ab / I' }, { value: 'Bbm',display: 'Bbm / ii' }, { value: 'Cm', display: 'Cm / iii' }, { value: 'Db', display: 'Db / IV' }, { value: 'Eb', display: 'Eb / V' }, { value: 'Fm', display: 'Fm / vi' }, { value: 'Gdim', display: 'Gdim / vii°' }, { value: 'Bb', display: 'Bb / V/V' }, { value: 'C', display: 'C / V/vi' }, { value: 'Gb', display: 'Gb / IV/IV' }],
  'A': [ { value: 'A',  display: 'A / I' }, { value: 'Bm', display: 'Bm / ii' }, { value: 'C#m',display: 'C#m / iii' }, { value: 'D',  display: 'D / IV' }, { value: 'E',  display: 'E / V' }, { value: 'F#m', display: 'F#m / vi' }, { value: 'G#dim', display: 'G#dim / vii°' }, { value: 'B', display: 'B / V/V' }, { value: 'C#', display: 'C# / V/vi' }, { value: 'G', display: 'G / IV/IV' }],
  'Bb': [ { value: 'Bb', display: 'Bb / I' }, { value: 'Cm', display: 'Cm / ii' }, { value: 'Dm', display: 'Dm / iii' }, { value: 'Eb', display: 'Eb / IV' }, { value: 'F',  display: 'F / V' }, { value: 'Gm', display: 'Gm / vi' }, { value: 'Adim', display: 'Adim / vii°' }, { value: 'C', display: 'C / V/V' }, { value: 'D', display: 'D / V/vi' }, { value: 'Ab', display: 'Ab / IV/IV' }],
